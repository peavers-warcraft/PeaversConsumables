-- PeaversConsumables luacheck config. Thin wrapper over the shared Peavers base (../wow-api).
...
for _, g in ipairs({"PeaversConsumablesDB"}) do globals[#globals + 1] = g end

-- Auction House API surface not yet in the curated wow std.
read_globals = { "C_AuctionHouse", "AuctionHouseFrameDisplayMode", "Item" }
